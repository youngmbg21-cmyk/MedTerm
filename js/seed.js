...
export function buildQuestions() {
  return [
    ...
    },
    {
      ...
      full: 'Not "would you use this" but "what would you pay, on what basis, out of whose budget". Per-seat, flat, per-contract, or services-with-software-attached are four different companies. The answer also decides whether the immediate build is billing and multi-tenancy, or nothing at all.',
    ...
    },
    {
      ...
      full: 'HaTi’s seal is cryptographically sound and rests on the Business Laws (Amendment) Act 2020, but it is not the accredited tier, and the product says so out loud. If a customer’s legal or IT reviewer treats accreditation as mandatory, the signing flow — the trust core of the product — is blocked, and HaTi is a repository with reminders.',
    ...
    },
    {
      ...
      full: 'The real competitor is not Ironclad or Juro. It is a folder on a shared drive, a WhatsApp thread, DocuSign for the signature, and a lawyer on retainer. That incumbent is free, already installed and universally understood. HaTi needs one thing it cannot do that a buyer will pay to have.',
